...
const App = () => {
    ...
    try {
      async function blueTooth() {
        const permissions = {
          ...
          message: 'HSD bluetooth requires access to bluetooth to process connection to bluetooth printer',
          buttonNeutral: 'Other Time',
          buttonNegative: 'Not',
          buttonPositive: 'Can',
        };
  ...
  return (
      <ScrollView style={styles.container}>
        ...
        <Text style={styles.sectionTitle}>Bluetooth connected to this phone:</Text>
